...
withCredentials: true,
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem('jwt_token', token); // Przechowaj token w localStorage lub sessionStorage
        localStorage.setItem('user_data', JSON.stringify(userData)); // Musisz przekształcić obiekt w ciąg znaków JSON
        setShowSuccess(true);
